...
\centering
	...
	\begin{subfigure}{.5\textwidth}
		...
		\label{fig:BoydMagic}
	\end{subfigure}
	\caption{a) Both clock states, here denoted $\ket{g_1}, \ket{g_2}$ are coupled to a different excited state: $\ket{e_1}, \ket{e_2}$ using the same trapping laser at 813 nm. b) Atomic polarizabilities of ${}^1S_0$ and ${}^3P_0$ showing a magic crossing around 813 nm. Grey line: experimental result. Figure adapted from \cite{Boyd2007}.}
