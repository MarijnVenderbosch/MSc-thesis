...
\begin{figure}
    \centering
    \includegraphics[width = 0.45\linewidth]{figures/LineSpacingCalibration.pdf}
...
\centering
    \centering
	\begin{subfigure}{.49\textwidth}
		\includegraphics[width=0.9\linewidth]{figures/3DSpotFitGaussian.pdf}
		\caption{}
		\label{fig:3Dshowing}
	\end{subfigure}
	\begin{subfigure}{.49\textwidth}
		\centering
		\includegraphics[width=0.9\linewidth]{figures/3DSpotFitGaussianSmaller.pdf}
		\caption{}
