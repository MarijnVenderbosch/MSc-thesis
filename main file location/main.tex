...
\chapter{Introduction}\label{ch:introduction}\input{chapter files/1introduction.tex}
\chapter{Laser Cooling and Trapping}\label{ch:coolingtrapping}\input{chapter files/2cooling_trapping}
\chapter{Making Optical Tweezers}\label{ch:tweezer}\input{chapter files/3tweezer.tex}
\chapter{Generating Tweezer Arrays}\label{ch:arrays}\input{chapter files/4arrays.tex}
\chapter{Implementation in the Machine}\label{ch:implementation}%\input{chapter files/5implementation.tex}
\chapter{Conclusions and Outlook}\label{ch:conclusion}%\input{chapter files/6conclusions.tex}
