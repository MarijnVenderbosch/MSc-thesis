...
%\input{tex files/acknowledgments.tex}

\tableofcontents
\newpage

% link page containing acronyms
\input{tex files/acronyms.tex}
\newpage

\pagenumbering{arabic}

\chapter{Introduction}\label{ch:introduction}\input{tex files/introduction.tex}
\chapter{Laser Cooling and Trapping}\label{ch:coolingtrapping}\input{tex files/coolingtrapping.tex}
\chapter{Making Optical Tweezers}\label{ch:tweezer}%\input{tex files/tweezer.tex}
\chapter{Generating Tweezer Arrays}\label{ch:arrays}\input{tex files/arrays.tex}
\chapter{Implementation in the Machine}\label{ch:implementation}%\input{tex files/implementation.tex}
\chapter{Conclusions and Outlook}\label{ch:conclusion}%\input{tex files/conclusions.tex}
...
\renewcommand\theequation{\thechapter.\arabic{equation}}
 ...
 \input{tex files/appendix_VQE.tex}
 \input{tex files/appendix_LightMatter.tex}
